...
<c:forEach var="basket1" items="${requestScope.basketList1}">
	<input type="text" size="50" id="pname" name="pname" readonly="readonly" value="${basket1.pname},${basket1.colorname }, size : ${basket1.psize },갯수:${basket1.cnt}"><br>
	<input type="text" size="50" class="price"id="price" name="price"  readonly="readonly" value="${basket1.price*basket1.cnt}"><br>
	</c:forEach>
	총계산액<br>
